...
#What if some of the column is significant to the model
##While some of them are not as significant as? Backward elimination
...
##Step 3, 4, 5 of backward elimination
##TO check the P-value, the lower the more significant
